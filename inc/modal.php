<div class="modal fade" id="video" tabindex="-1" role="dialog" aria-labelledby="videoModal" aria-hidden="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-cta">
                <strong>Inspiring hope in the fight against stage IV breast cancer</strong> <a href="" id="video-donate-btn" data-dismiss="modal" data-toggle="modal" class="btn" data-target="#donate">Donate Now</a>
            </div>
        </div>
    </div>
</div>
